<?php
   ...
   update_programa($id_ies, $denominacion, $programa_educativo, $inicio, $unidad, $unidad_1, $unidad_2, $unidad_3, $unidad_4, $periodo, $sex_fem, $sex_mas, $egresados_f, $egresados_m);
?>
    <script>
       window.location="../view/editar_programa.php?var=<?php echo base64_encode($id_ies) ?>"
    </script>
<?php
