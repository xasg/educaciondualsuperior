                                          ...
                                          <tr>  
                                            ...
                                            <tbody>
                                              ...
                                              <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#convenio" data-nombre="<?php echo $prog['dt_programa']; ?>" data-id="<?php echo $prog['id_programa']?>"><i class='glyphicon glyphicon-upload'></i>&nbsp;&nbsp;&nbsp;&nbsp;Agregar&nbsp;&nbsp;&nbsp;&nbsp;</button>
                                                </td>
                                                <td> 
                                                    ...
                                                    while($row = mysqli_fetch_array($result)){
                                                        ?>
                                                          <tr>
                                                           ...
                                                           <td>
                                                           <button type="button" class="btn btn-block btn-primary" data-toggle="modal" data-target="#unidad" data-nombre="<?php echo $row['dt_unidad']; ?>" data-id="<?php echo $row['id_unidad_educativa']?>" data-convenio="<?php echo $row['dt_convenio']?>" data-estudiante_fem="<?php echo $row['dt_estudiante_fem']?>" data-estudiante_mas="<?php echo $row['dt_estudiante_mas']?>" data-docente_fem="<?php echo $row['dt_docente_mas']?>" data-docente_mas="<?php echo $row['dt_docente_mas']?>" data-egresados_fem="<?php echo $row['dt_egresados_fem']?>" data-egresados_mas="<?php echo $row['dt_egresados_mas']?>"><i class='glyphicon glyphicon-upload'></i>&nbsp;&nbsp;&nbsp;&nbsp;Detalles&nbsp;&nbsp;&nbsp;&nbsp;</button> 
                                                           </td>
                                                          </tr>
                                                        <?php
                                                    }
