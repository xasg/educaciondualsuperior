...
if ($resultado->num_rows > 0) 
{
    ...
    $estatus_2022 = $row["tp_estatus_2022"];
...
<!--Finalizar la carga de Programas Educativos -->
                                  ...
                                  <?php   if( $estatus_2022==0){ ?>
                                    <div class="row">
                                       <div class="col-md-3">
                                         <a href="programa.php?ciclo=2022-2023" class="btn btn-block btn-primary" aria-disabled="true">Agregar o Editar</a>
                                    </div>
                                    <?php   if( $row_cnt>=1){ ?>
                                    <div class="col-md-4">
